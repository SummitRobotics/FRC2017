...
class Gossamer extends Thread
{
	...
	public void run ()
	{
		...
		turnWithGyro(.5, 45);
		//move forward slowly to deposit gear
		autoProgram.assignPower(.1,.1);
		autoProgram.hall.givenDistance(10, 2);
		autoProgram.assignPower(0,0)
		//let the gear hook on
		delay(500);
		//backup
		autoProgram.assignPower(-.1, -.1);
		autoProgram.hall.givenDistance(10, 2);
