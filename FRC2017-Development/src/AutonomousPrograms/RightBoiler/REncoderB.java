package AutonomousPrograms.RightBoiler;
...
public class REncoderB extends AutonomousProgram 
{
	...
	//constructor
	public REncoderB(Robot robot, String name)
	{
		super(robot, name);
...
class GossamerA extends Thread
{
	...
	public GossamerA (REncoderB program)
	{
		autoProgram = program;
	...
	public void run ()
	{
		...
		autoProgram.hall.givenDistance(4, autoProgram.hall.countsGivenFt(autoProgram.mainRobot.hardwareMap.distanceB));
		autoProgram.assignPower(0, 0);
		turnWithGyro(.4, -45);
		autoProgram.assignPower(.2, .2);
		autoProgram.hall.givenDistance(8, autoProgram.hall.countsGivenFt(autoProgram.mainRobot.hardwareMap.distanceC));
		autoProgram.assignPower(0, 0);
	}
