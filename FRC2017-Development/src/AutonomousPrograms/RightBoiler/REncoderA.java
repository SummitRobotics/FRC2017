...
public class REncoderA extends AutonomousProgram 
{
	...
	//constructor
	public REncoderA(Robot robot, String name)
	{
		super(robot, name);
...
class GossamerA extends Thread
{
	...
	public GossamerA (REncoderA program)
	{
		autoProgram = program;
	...
	public void run ()
	{
		...
		autoProgram.hall.givenDistance(10, autoProgram.hall.countsGivenFt(autoProgram.mainRobot.hardwareMap.distanceA));
