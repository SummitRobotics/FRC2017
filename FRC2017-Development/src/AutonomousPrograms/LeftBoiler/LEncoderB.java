package AutonomousPrograms.LeftBoiler;
...
public class LEncoderB extends AutonomousProgram 
{
	...
	//constructor
	public LEncoderB(Robot robot, String name)
	{
		super(robot, name);
...
class GossamerA extends Thread
{
	...
	public GossamerA (LEncoderB program)
	{
		autoProgram = program;
