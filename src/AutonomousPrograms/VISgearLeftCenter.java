...
public class VISgearLeftCenter extends AutonomousProgram{
	...
	//reference gyro and thread for auto functions
		...
		public VISgearLeftCenter(Robot robot, String name)
		{
			super(robot, name);
		}
...
class VGLC extends Thread
{
	//Reference the auto class
	VISgearLeftCenter autoProgram;
	
	//Constructor saves an instance of auto class for reference
	public VGLC (VISgearLeftCenter VISgearStraightBlueCenter)
	{
