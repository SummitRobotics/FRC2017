...
public class gearStraightRedCenter extends AutonomousProgram 
{
	...
	//constructor
	public gearStraightRedCenter(Robot robot, String name)
	{
		super(robot, name);
...
class GStrRC extends Thread
{
	...
	gearStraightRedCenter autoProgram;
	...
	public GStrRC (gearStraightRedCenter program)
	{
		autoProgram = program;
