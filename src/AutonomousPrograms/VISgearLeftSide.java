...
public class VISgearLeftSide extends AutonomousProgram{
	...
	//reference gyro and thread for auto functions
		...
		//constructor
		public VISgearLeftSide(Robot robot, String name)
		{
			super(robot, name);
		}
	...
	class VGLS extends Thread
	{
		//Reference the auto class
		VISgearLeftSide autoProgram;

		//Constructor saves an instance of auto class for reference
		public VGLS (VISgearLeftSide VISgearLeftSide)
		{
			autoProgram = VISgearLeftSide;
		...
		public void run ()
		{
			//Vision gear left peg, left side
			//Forward for 1.2s
			autoProgram.autoUtilities.forwardWithGyro(0.5, 1.2);
			
			//Turn right to face peg
