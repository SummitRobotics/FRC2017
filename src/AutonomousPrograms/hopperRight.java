...
public class hopperRight extends AutonomousProgram
{
	...
	//constructor
	public hopperRight(Robot robot, String name)
	{
		super(robot, name);
	}
...
class HR extends Thread
{
	...
	hopperRight autoProgram;

	//Constructor saves an instance of auto class for reference
	public HR (hopperRight hopperRight)
	{
		autoProgram = hopperRight;
