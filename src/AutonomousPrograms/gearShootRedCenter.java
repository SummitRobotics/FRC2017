...
public class gearShootRedCenter extends AutonomousProgram 
{
	...
	//constructor
	public gearShootRedCenter(Robot robot, String name)
	{
		super(robot, name);
...
class gear1 extends Thread
{
	...
	gearShootRedCenter autoProgram;
	...
	public gear1 (gearShootRedCenter program)
	{
		autoProgram = program;
