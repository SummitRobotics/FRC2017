...
public class hopperShootBlueSide extends AutonomousProgram 
{
	...
	//constructor
	public hopperShootBlueSide(Robot robot, String name)
	{
		super(robot, name);
...
class gear2 extends Thread
{
	...
	hopperShootBlueSide autoProgram;
	...
	public gear2 (hopperShootBlueSide program)
	{
		autoProgram = program;
